        ...
        <div class="col-md-12">
            <div class="card" style="margin-top: 50px;">
                <div class="card-body">
                    ...
                    <h4><p class="card-text">Anda berada di pusat kendali SMA Negeri 2 Mandrehe. Kelola informasi dengan efisiensi dan gaya.</p></h4> <br>
                    <div class="row mt-4">
                        <div class="col-md-4">
                            <a class="btn btn-primary btn-lg btn-block" href="tampil-siswa.php" role="button">Data Siswa</a>
                        </div>
                        <div class="col-md-4">
                            <a class="btn btn-success btn-lg btn-block" href="pendaftaran.php" role="button">Pendaftaran Baru</a>
                        </div>
                        <div class="col-md-4">
